...
Namespace WindowsApplication53
    ...
    Public Class MyPivotGridViewInfoData
        ...
        Private Function IFilteredComponent_CreateFilterColumnCollection() As IBoundPropertyCollection Implements IFilteredComponent.CreateFilterColumnCollection
            Dim collection As IBoundPropertyCollection = New FieldFilterColumnCollection(Fields, MenuManager)
